...
public class GameEngineCallbackImpl implements GameEngineCallback
{
   ...
   public void nextCard(Player player, PlayingCard card, GameEngine engine)
   {
      ...
      logger.log(Level.FINE, String.format("Card Dealt to %s", player.getPlayerName() + card.toString()));
   }
   ...
   {
      logger.log(Level.INFO, String.format("Card dealt to the %s .. ", player.getPlayerName() + card.toString() + " ... YOU BUSTED!"));
   }

   @Override
   public void nextHouseCard(PlayingCard card, GameEngine engine)
   {
      logger.log(Level.INFO, String.format("Card dealt to House .. " + card.toString()));
   }

   @Override
   public void houseBustCard(PlayingCard card, GameEngine engine)
   {
      logger.log(Level.INFO, String.format("Card dealt to House .. " + card.toString() + " ... HOUSE BUSTED!"));
   }
